...
//
// All Firebase project values are injected at build/run time via
// --dart-define-from-file=.env (or --dart-define=KEY=value). Nothing secret is
// committed in source. See .env.example for the required variables.
